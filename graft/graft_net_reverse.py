...
def graft_net(args, student, teacher_dict, saved_blocks, block_id):
	if block_id == 1:
		optimizer = optim.SGD(student.parameters(), lr=args.lr_net, weight_decay=args.weight_decay, momentum=0.9)
	elif block_id == 2:
		...
		optimizer = optim.SGD([{'params':student.layer2.parameters()}, {'params': student.layer3.parameters()}, {'params': student.layer4.parameters()}], lr=args.lr_net, weight_decay=args.weight_decay, momentum=0.9)
	elif block_id == 3:
		# teacher_dict.update({'layer1': saved_blocks['layer1'], 'layer2': saved_blocks['layer2'], 'layer3': saved_blocks['layer3']})
		# student.load_state_dict(teacher_dict)
		optimizer = optim.SGD([{'params':student.layer3.parameters()}, {'params': student.layer4.parameters()}], lr=args.lr_net, weight_decay=args.weight_decay, momentum=0.9)
	elif block_id == 4:
		# teacher_dict.update(saved_blocks)
		# student.load_state_dict(teacher_dict)
		optimizer = optim.SGD([{'params':student.layer4.parameters()}, {'params': student.linear.parameters()}], lr=args.lr_net, weight_decay=args.weight_decay, momentum=0.9)
...
def main():
	...
	parser.add_argument('--lr_net', type=float, default=0.001, metavar='LR', help='learning rate (default: 0.1)')
	...
	param_string = "wo_adjlr_e_{}_npc_{}_ps_{}_wd1_{}_lrn_{}_lrgp_{}"
	param_string = param_string.format(args.epochs, args.num_per_class, args.patch_size, args.loss_weight_d1, args.lr_net, args.lr_Gp)
	...
	ckpt_path = f'{args.input_dir}/teacher/cifar10-resnet18.pt'

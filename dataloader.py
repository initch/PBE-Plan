...
def get_mean_std(args):
	...
	elif args.dataset.lower()=='cifar10' or args.dataset.lower()=='cifar10few':
		return {"mean":[0.4914, 0.4822, 0.4465], "std":[0.2023, 0.1994, 0.2010]}

	elif args.dataset.lower()=='cifar100' or args.dataset.lower()=='cifar100few':
...
def get_dataset(args):
	if args.dataset.lower()=='mnist':
		...
		train_dataset = datasets.SVHN("/home/bei_chen/data", split="train", download=True,
						transform=transforms.Compose([
		...
		test_dataset = datasets.SVHN("/home/bei_chen/data", split="test", download=True,
					   transform=transforms.Compose([
							transforms.ToTensor(),
							get_norm_trans(args),
						]))
		...
		train_dataset = datasets.CIFAR10("/home/bei_chen/data", train=True, download=False,
						transform=transforms.Compose([
								transforms.RandomCrop(32, padding=4),
								transforms.RandomHorizontalFlip(),
								transforms.ToTensor(),
		...
		test_dataset = datasets.CIFAR10("/home/bei_chen/data", train=False, download=False,
					   transform=transforms.Compose([
							transforms.ToTensor(),
							get_norm_trans(args),
						]))
		...
		train_dataset = datasets.CIFAR100("/home/bei_chen/data", train=True, download=False,
					   transform=transforms.Compose([
							transforms.RandomCrop(32, padding=4),
							transforms.RandomHorizontalFlip(),
							transforms.ToTensor(),
		...
		test_dataset = datasets.CIFAR100("/home/bei_chen/data", train=False, download=False,
					   transform=transforms.Compose([
							transforms.ToTensor(),
							get_norm_trans(args),
						]))
	
	elif args.dataset.lower() == 'cifar10few':
		train_dataset = CIFAR10Few('/home/bei_chen/data', args.num_per_class,
				   transform=transforms.Compose([
								transforms.RandomCrop(32, padding=4),
								transforms.RandomHorizontalFlip(),
								transforms.ToTensor(),
	...
	elif args.dataset.lower() == 'cifar100few':
		train_dataset = CIFAR100Few('/home/bei_chen/data', args.num_per_class,
				   transform=transforms.Compose([
								transforms.RandomCrop(32, padding=4),
								transforms.RandomHorizontalFlip(),
								transforms.ToTensor(),
		...
		train_dataset = ImageFolderDataset("/mnt/ext/bei_chen/VGGface2/train_cls_subset", 
		...
		test_dataset = ImageFolderDataset("/mnt/ext/bei_chen/VGGface2/test_cls_subset", 
						preprocess_before = transforms.Compose([
							transforms.Resize(84),
							transforms.CenterCrop(64),
						]),
		...
		train_dataset = ImageFolderDataset("/mnt/ext/bei_chen/mini-imagenet/train", 
						preprocess_before = transforms.Compose([
		...
		test_dataset = ImageFolderDataset("/mnt/ext/bei_chen/mini-imagenet/test", 
						preprocess_before = transforms.Compose([
							transforms.Resize(64),
						]),
					   transform=transforms.Compose([
